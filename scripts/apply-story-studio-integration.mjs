...
const runtimeTags = [
  ...
  '<script src="public/js/story-drive-reference-runtime.js"></script>',
...
if (!missingTags.length) {
  console.log(`[ColorVerse] Story, Drive references, review, separate editions, images, and PDF links are already connected: ${target}`);
  process.exit(0);
}
